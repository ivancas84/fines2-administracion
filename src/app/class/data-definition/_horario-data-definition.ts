...
export class _HorarioDataDefinition extends DataDefinition {
  ...
  storage(row: { [index: string]: any }){
    ...
    && ('domicilio_' in row['curso_']['comision_']['sede_']['coordinador_'])
    ){
      this.stg.setItem('domicilio' + row['curso_']['comision_']['sede_']['coordinador_']['domicilio_'].id, row['curso_']['comision_']['sede_']['coordinador_']['domicilio_']);
      delete row['curso_']['comision_']['sede_']['coordinador_']['domicilio_'];
    }
    if(('curso_' in row)
    && ('comision_' in row['curso_'])
    && ('sede_' in row['curso_']['comision_'])
    ...
    && ('domicilio_' in row['curso_']['comision_']['comision_siguiente_']['sede_']['coordinador_'])
    ){
      this.stg.setItem('domicilio' + row['curso_']['comision_']['comision_siguiente_']['sede_']['coordinador_']['domicilio_'].id, row['curso_']['comision_']['comision_siguiente_']['sede_']['coordinador_']['domicilio_']);
      delete row['curso_']['comision_']['comision_siguiente_']['sede_']['coordinador_']['domicilio_'];
    }
    if(('curso_' in row)
    && ('comision_' in row['curso_'])
    && ('comision_siguiente_' in row['curso_']['comision_'])
